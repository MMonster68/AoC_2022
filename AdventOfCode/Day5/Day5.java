    ...
    public static void main(String[] args) throws IOException {
        ...
        while (sc.hasNextLine()) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                switch(finish) {
                    case 1: s1.push(m.pop());
                            break;
                    case 2: s2.push(m.pop());
                            break;
                    case 3: s3.push(m.pop());
                            break;
                    case 4: s4.push(m.pop());
                            break;
                    case 5: s5.push(m.pop());
                            break;
                    case 6: s6.push(m.pop());
                            break;
                    case 7: s7.push(m.pop());
                            break;
                    case 8: s8.push(m.pop());
                            break;
                    case 9: s9.push(m.pop());
                            break;
                }
